      ...
      <div className="overflow-x-auto scrollbar-thin scrollbar-thumb-primary/30 scrollbar-track-transparent pb-2">
        <div className="flex gap-5 min-w-max">
          {TECH_ITEMS.map((item, i) => (
            ...
            >
              <div className="w-10 h-10 flex items-center justify-center rounded-md border border-border bg-terminal-block/50 group-hover:border-primary/50 group-hover:bg-primary/10 transition-all duration-200">
                <img
                  src={item.logo}
                  alt={item.label}
